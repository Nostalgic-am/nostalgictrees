...
public class NTJadePlugin implements IWailaPlugin {
    ...
    public void register(IWailaCommonRegistration registration) {
        registration.registerBlockDataProvider(SaplingComponentProvider.INSTANCE, ResourceSaplingBlock.class);
        registration.registerBlockDataProvider(DryingRackComponentProvider.INSTANCE, DryingRackBlock.class);
    }
